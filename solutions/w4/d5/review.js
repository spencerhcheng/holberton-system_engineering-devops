...
replacing the vowels in curse words with "*".

Use Array.prototype.forEach.

Examples:
censor("Darn you Harold you son of a gun!", ["darn", "gun"]); //=> "D*rn you Harold you son of a g*n!"
censor("Schnikeys I don't give a diddly squat", ["schnikeys", "diddly", "squat"]) //=> "Schn*k*ys I don't give a d*ddly sq**t"
******************************************************************************/
...
var half = function(num) { r
  eturn num / 2;
};
greatestMapCreator(ary1, squareRootRounder, half); //=> []
...
greatestMapCreator(ary2, absoluteValue, fraction); //=>
******************************************************************************/
